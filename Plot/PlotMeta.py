...
class CSeg_meta:
    def __init__(self, seg: CSeg):
        ...
        self.zs_scene_discarded_zs = list(getattr(seg, "zs_scene_discarded_zs_list", []) or [])
...
class CDisplaySeg_meta:
    def __init__(self, seg: dict):
        ...
        self.extra_notes = list(seg.get("extra_notes", []))
        self.is_zs_scene = bool(seg.get("is_zs_scene", False))
